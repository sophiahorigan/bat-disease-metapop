...
getwd()
#load data
setwd("/Users/caraebrook/Documents/R/R_repositories/bat-matrix")#JAE_Sept2018/revisions_Dec2018/refits/")
...
refit.out.MSIRN.Eid.one.matAB <- wrap.msir.fit.wane.age.CI.method2(model="MSIRN",
                                                          dat1=dat.tot,
...
save(refit.out.MSIRN.Eid.one.matAB, file="refit.out.MSIRN.Eid.one.matAB.Rdata")
