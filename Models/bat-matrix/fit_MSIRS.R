...
#getwd()
#load data
homewd = "/Users/caraebrook/Documents/R/R_repositories/bat-matrix"
setwd(homewd)
...
wrap.msir.fit.wane.age.CI.method2 <- function(model, dat1, cutoff1, species1, type1, vis_split, s, sim_pop, yrs, ntyr, recov, sero, wane, sigma, sigma2, boost, mort, mort_juv, N_stat,
  ...
  dat.tmp <- subset(dat1, species==species1 & type==type1)
  dat.tmp <- subset(dat.tmp, !is.na(age))
  #dat.tmp <- subset(dat.tmp, fit==1) #keep it
...
fit.out.MSIRS.Eid.one <- wrap.msir.fit.wane.age.CI.method2(model="MSIRS",
                                                           dat1=dat.tot,
...
save(fit.out.MSIRS.Eid.one, file="fit.out.MSIRS.Eid.one.Rdata")



fit.out.MSIRS.Eid.lci <- wrap.msir.fit.wane.age.CI.method2(model="MSIRS",
                                                           dat1=dat.tot,
                                                           species1 = "Eidolon dupreanum",
                                                           type1="NIVG",
                                                           cutoff1 = "lci",
...
save(fit.out.MSIRS.Eid.lci, file="fit.out.MSIRS.Eid.lci.Rdata")


fit.out.MSIRS.Eid.uci <- wrap.msir.fit.wane.age.CI.method2(model="MSIRS",
                                                           dat1=dat.tot,
                                                           species1 = "Eidolon dupreanum",
                                                           type1="NIVG",
                                                           cutoff1 = "uci",
...
save(fit.out.MSIRS.Eid.uci, file="fit.out.MSIRS.Eid.uci.Rdata")
